...
model_ids = [
    ('mistralai/Mistral-7B-Instruct-v0.1', f'{cache_dir}/models--mistralai--Mistral-7B-Instruct-v0.1/snapshots/ec5deb64f2c6e6fa90c1abf74a91d5c93a9669ca'),
    ('mistralai/Mistral-7B-Instruct-v0.2', f'{cache_dir}/models--mistralai--Mistral-7B-Instruct-v0.2/snapshots/63a8b081895390a26e140280378bc85ec8bce07a'),
    ('mistralai/Mistral-7B-Instruct-v0.3', f'{cache_dir}/models--mistralai--Mistral-7B-Instruct-v0.3/snapshots/c170c708c41dac9275d15a8fff4eca08d52bab71'),
    ('mistralai/Mistral-Nemo-Instruct-2407', f'{cache_dir}/models--mistralai--Mistral-Nemo-Instruct-2407/snapshots/04d8a90549d23fc6bd7f642064003592df51e9b3'),
    ('mistralai/Codestral-22B-v0.1', f'{cache_dir}/models--mistralai--Codestral-22B-v0.1/snapshots/28b1c1a51dabe9d86ca8c41420ada1984632498f'),
    ('mistralai/Mistral-Small-24B-Instruct-2501', f'{cache_dir}/models--mistralai--Mistral-Small-24B-Instruct-2501/snapshots/9527884be6e5616bdd54de542f9ae13384489724')
]
...
for model_id in model_ids:
    ...
    for _, row in df.iterrows():
        ...
        top_probs_hist = []
        if re.search('Small', model_id[0]):
            target_ids = ChatCompletionRequest(messages=[UserMessage(role='user', content=row['target'])])
            target_ids = tokenizer.encode_chat_completion(target_ids).tokens[2:-1] + eos_token  
            request = ChatCompletionRequest(messages=[UserMessage(role='user', content=f'{prompt}\n{row["user"]}')])
            input_data = tokenizer.encode_chat_completion(request)
            input_ids = torch.tensor([input_data.tokens]).to(model.device)
