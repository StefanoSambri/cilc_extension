...
model_ids = [
    ('microsoft/Phi-3-mini-128k-instruct', f'{cache_dir}/models--microsoft--Phi-3-mini-128k-instruct/snapshots/f3c06aed622e14ca0abf5115094e4fc9a9948f36'),
    ('microsoft/Phi-3.5-mini-instruct', f'{cache_dir}/models--microsoft--Phi-3.5-mini-instruct/snapshots/2fe192450127e6a83f7441aef6e3ca586c338b77/'),
    ('microsoft/Phi-3-small-128k-instruct', f'{cache_dir}/models--microsoft--Phi-3-small-128k-instruct/snapshots/e95b185a59a58450c9b1dd7347a9dee78f18113e'),
    ('microsoft/Phi-3-medium-128k-instruct', f'{cache_dir}/models--microsoft--Phi-3-medium-128k-instruct/snapshots/a088b37c71d441ab6d862bb3fcfe6165b3014702'),
    ('microsoft/Phi-3.5-MoE-instruct', f'{cache_dir}/models--microsoft--Phi-3.5-MoE-instruct/snapshots/43688451b462a3351d8580625ebe1931adb3986d')
]
...
for model_id in model_ids:
    ...
    if re.search(r'-small-', model_id[0]) or re.search(r'-MoE-', model_id[0]): trust_remote_code = True
